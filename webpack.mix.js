...
//mix.sass('resources/assets/admin/scss/admin.scss', 'resources/assets/admin/css/'); 
...
// mix.js('resources/assets/core/js/app.js', 'public/assets/app/js');
...
mix.styles('resources/assets/auth/css/login.css', 'public/assets/auth/css/login.css');
mix.styles('resources/assets/auth/css/register.css', 'public/assets/auth/css/register.css');
mix.styles('resources/assets/auth/css/passwords.css', 'public/assets/auth/css/passwords.css');
...
mix.scripts([
    ...
    'resources/assets/plugins/PNotify/pnotify.custom.min.js',
...
mix.styles([
    'node_modules/bootstrap/dist/css/bootstrap.css',
    'node_modules/gentelella/vendors/animate.css/animate.css',
    'resources/assets/plugins/PNotify/pnotify.custom.min.css',
    'node_modules/gentelella/build/css/custom.css',
...
// User
mix.js('resources/assets/admin/js/users/users.js', 'public/assets/admin/js/users/');
...
], 'public/assets/admin/js/users/edit-plugins.js');

mix.js('resources/assets/admin/js/users/edit.js', 'public/assets/admin/js/users/');

mix.styles([
    'node_modules/select2/dist/css/select2.css',
], 'public/assets/admin/css/users/edit-plugins.css');
